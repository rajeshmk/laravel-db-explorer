...
Route::middleware(array_merge(
    ...
    ->group(function () {
        ...
        Route::get('/table/{table}/records/{mode?}', [ExplorerController::class, 'table'])
            ->whereIn('mode', ['raw', 'editable'])
            ->name('db-explorer.table.records');
        ...
        Route::get('/table/{table}/column/{column}/options', [ExplorerController::class, 'columnOptions'])
            ->name('db-explorer.column.options');
